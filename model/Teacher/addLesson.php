...
// ==================Video Upload End ========================
  ...
  $sql="INSERT INTO `lesson` (`lessonID`, `classID`, `subject`, `teacher`, `LessonTitle`, `description`, `date`, `image`, `video`, `timestamp`) VALUES (NULL, '$classID', '$subject', '$teacherID', '$Lesson', '$des', '$date', '$filePath', '$videoPath', current_timestamp());";

  $result=mysqli_query($con,$sql);
  if($result)
  {
    session_start();
    header('location:../../view/TeacherView/lesson.php?teacherID=5');
