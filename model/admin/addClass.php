...
if($_SERVER['REQUEST_METHOD'] == 'POST')
{
  ...
  if(isset($_POST['level']))
  {
   ...
   $sql="INSERT INTO `class` (`classID`, `teacherID`, `classTitel`, `className`, `subject`, `grade`, `description`, `image`, `level`, `type`, `timestamp`) VALUES (NULL, '$teacher', '$classTitle', '$className', '$subject', '$grade', '$des', '$filePath', '$level', '$type', current_timestamp());";
