...
if($_SERVER['REQUEST_METHOD'] == 'POST'){
  ...
  else
  {
    ...
    $sql="UPDATE `teacher` SET `name` = '$name', `NIC` = '$NIC', `sex` = '$sex', `address` = '$address', `mobile` = '$mobile', `description` = '$dis', `Univicity` = '$Uni', `degree` = '$degree', `userName` = '$userName', `password` = '$password', `Timage` = '$filePath', `subject` = '$subject', `level` = '$level' WHERE `teacher`.`teacherID` = $Tid;";
